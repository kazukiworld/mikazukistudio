...
export default function Home() {
  ...
  return (
    <main className={`${modelLoading ? 'fixed' : 'relative'}`}>
      <div className='relative text-yellow-50'>
        ...
        <div ref={heroSection} className={`z-20 relative px-4 lg:px-24 lg:w-1/2 h-screen flex flex-col justify-center space-y-4 lg:space-y-8`}>
          <h1 className={`font-custom text-4xl w-4/5 lg:text-6xl transition-all duration-1000 ease-in-out ${modelLoading ? 'opacity-0' : 'opacity-100'}`}>
        ...
        <div ref={aboutSection} className='z-20 w-full h-screen space-y-24 px-4 lg:py-24 lg:px-48 flex flex-col justify-center items-center relative'>
          <div className='flex justify-end items-center space-x-8'>
            <h1 className={`font-custom w-2/3 lg:w-1/3 text-3xl lg:text-5xl text-end transition-all duration-700 ease-in-out ${currentSection == 'About' ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
