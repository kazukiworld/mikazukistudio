...
export default function DownArrowBtn() {
    ...
    return (
        <div>
            <button onClick={handleArrowClick} className={`z-40 fixed bottom-8 right-8 w-auto md:w-full flex justify-center items-center transition-all ${end ? 'opacity-0' : 'opacity-100'}`}>
